...
export const tonePanels: TonePanelData[] = [
  {
    ...
    variant: 'cold',
    description:
      'Desaturated palettes — greys, muted blues, pale yellows. Dusty, sterile production design. Framing is deadpan, flat, and wide, emphasizing the absurdity of the institution. Think Patriot. Every object is precisely placed. Every silence is too long.',
  },

  {
    ...
    variant: 'warm',
    description:
      "Handheld or fluid camera movements during creative sessions. Spaces cluttered with instruments, art, life and love. The palette warms and loosens as the series moves toward 1970.",
  },
];
...
export const featuredCharacters: CharacterCardData[] = [
  {
    ...
    description:
      "<strong>Nigel</strong> begins motivated by a single goal: reaching his government pension with <strong>minimal fuss</strong>. Over five years, his motivations transform completely — from protecting his pension to protecting innocent people from his own government's folly.",
  },
  {
    ...
    description:
      "<strong>Clive</strong> sees Operation Minuet as his magnum opus — <strong>a five-year artistic masterpiece</strong> that will revolutionize intelligence work. His invented spy jargon ('psychological ricochet', 'unintentional success matrix') transforms bumbling surveillance into what he believes is sophisticated psychological warfare.",
  },
];
...
export const episodes: Episode[] = [
  {
    ...
    summary:
      "After The Beatles smoke a joint in the Buckingham Palace bathroom, John Lennon makes a flippant remark about military service that triggers Prince Philip's fury. Operation Minuet is born. Nigel sighs. Clive is energized.",
    tension: 25,
...

  {
    ...
    summary:
      "Sgt. Pepper convinces Philip the threat is real. The 'Klaus' persona is born. Clive begins his masterpiece within the masterpiece. Nigel guides George Harrison toward India — fulfilling orders while minimizing harm. The last innocent summer ends.",
    tension: 35,
...

  {
    ...
    summary:
      "John returns his MBE. Philip's fury crystallizes into a demand for 'permanent administrative solution.' The order is received. Clive sees a third-act twist. Nigel sees a man he has come to recognize as human. He makes his choice.",
    tension: 75,
